...
import com.example.roomcronoapp.ui.theme.ApplyFontDoppioOne
import com.example.roomcronoapp.ui.theme.ApplyFontShareTechMono
import com.example.roomcronoapp.ui.theme.Black1
import com.example.roomcronoapp.ui.theme.Blue1
...
fun ContentEditView(
    ...
    Column(
        ...
        Text(
            ...
            fontSize = 80.sp,
            fontFamily = ApplyFontShareTechMono,
            color = Blue1
        )
        ...
        Row(
            ...
            Button(
                ...
                Text(text = "Editar", fontSize = 22.sp, fontFamily = ApplyFontDoppioOne)
            }
